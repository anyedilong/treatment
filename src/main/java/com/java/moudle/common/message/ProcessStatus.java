...
public class ProcessStatus implements Serializable {
	...
	public final static ProcessStatus DEVICE_ERROR=new ProcessStatus(2006,"设备已删除");
	public final static ProcessStatus USER_ERROR=new ProcessStatus(2007,"用户无法使用该设备");
	public final static ProcessStatus USER_STATUS=new ProcessStatus(2008,"用户已冻结");
