package com.java.moudle.turnin.domain;
...
@Entity
@Table ( name ="TM_TURN_IN" )
public class TmTurnIn  extends BaseDomain  {

	private static final long serialVersionUID =  4288521210034889665L;
	...
	@Transient
	private List<TurnOutDto> historyTurnOut;//历史转诊信息
	@Transient
	...
	public List<TurnOutDto> getHistoryTurnOut() {
		return historyTurnOut;
	}

	public void setHistoryTurnOut(List<TurnOutDto> historyTurnOut) {
		this.historyTurnOut = historyTurnOut;
	}
